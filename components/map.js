...
export default class App extends React.Component {
  ...
  render(){
    ...
    return (
      <ImageBackground  source={{uri:"https://bit.ly/3meySwm"}} blurRadius={0.05} style={styles.container}>
        <View style={styles.overlay}>
          <Image source={require("../components/images/123.jpg")} style={{width:100,height:100}} />
